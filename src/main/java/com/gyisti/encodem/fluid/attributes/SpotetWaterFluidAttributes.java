...
package com.gyisti.encodem.fluid.attributes;
...
public class SpotetWaterFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, SpotetWaterFluidAttributes::new);
	}
	...
	protected SpotetWaterFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
